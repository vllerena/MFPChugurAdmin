@extends('layouts.vertical', ['title' => 'Reporte General'])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Reporte General</h4>
                </div>
            </div>
        </div>
        <div class="row">
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#selectEmpresa").on("select2:select", async function (e) {
                ...
                let data = await fetchData(empresa, dateinicio, datefin);
                crearTable(data);
                resumenDatos(data);
            });

            async function fetchData(empresa, dateinicio, datefin) {
                ...
                $("#loadData").html(
                    ...
                    .hide().fadeIn('slow');
                let res = await fetch('/api/admin/reportes/' + empresa + '/' + dateinicio + '/' + datefin)
