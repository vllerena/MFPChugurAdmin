...
getFiles(folder.src + "js/custom").forEach(function (filepath) {
    mix.js(folder.src + "js/custom/" + filepath, folder.dist_assets + "js/custom/" + filepath);
});

mix.js('resources/js/custom/app.js', 'public/js')
    .vue()
